...
// 	protoc        (unknown)
// source: proto/collector/trace/v1/trace_service.proto

package collector_trace
...
func (x *ExportTraceServiceRequest) Reset() {
	*x = ExportTraceServiceRequest{}
	mi := &file_proto_collector_trace_v1_trace_service_proto_msgTypes[0]
...
func (*ExportTraceServiceRequest) Descriptor() ([]byte, []int) {
	return file_proto_collector_trace_v1_trace_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *ExportTraceServiceResponse) Reset() {
	*x = ExportTraceServiceResponse{}
	mi := &file_proto_collector_trace_v1_trace_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExportTraceServiceResponse) Descriptor() ([]byte, []int) {
	return file_proto_collector_trace_v1_trace_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *ExportTracePartialSuccess) Reset() {
	*x = ExportTracePartialSuccess{}
	mi := &file_proto_collector_trace_v1_trace_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExportTracePartialSuccess) Descriptor() ([]byte, []int) {
	return file_proto_collector_trace_v1_trace_service_proto_rawDescGZIP(), []int{2}
}
...
var File_proto_collector_trace_v1_trace_service_proto protoreflect.FileDescriptor

const file_proto_collector_trace_v1_trace_service_proto_rawDesc = "" +
	"\n" +
	",proto/collector/trace/v1/trace_service.proto\x12&opentelemetry.proto.collector.trace.v1\x1a(opentelemetry/proto/trace/v1/trace.proto\"o\n" +
	...
	"\x06Export\x12A.opentelemetry.proto.collector.trace.v1.ExportTraceServiceRequest\x1aB.opentelemetry.proto.collector.trace.v1.ExportTraceServiceResponse\"\x00B\x96\x01\n" +
	")io.opentelemetry.proto.collector.trace.v1B\x11TraceServiceProtoP\x01Z+gen/otlp/collector/trace/v1;collector_trace\xaa\x02&OpenTelemetry.Proto.Collector.Trace.V1b\x06proto3"

var (
	file_proto_collector_trace_v1_trace_service_proto_rawDescOnce sync.Once
	file_proto_collector_trace_v1_trace_service_proto_rawDescData []byte
)

func file_proto_collector_trace_v1_trace_service_proto_rawDescGZIP() []byte {
	file_proto_collector_trace_v1_trace_service_proto_rawDescOnce.Do(func() {
		file_proto_collector_trace_v1_trace_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_collector_trace_v1_trace_service_proto_rawDesc), len(file_proto_collector_trace_v1_trace_service_proto_rawDesc)))
	})
	return file_proto_collector_trace_v1_trace_service_proto_rawDescData
}

var file_proto_collector_trace_v1_trace_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_collector_trace_v1_trace_service_proto_goTypes = []any{
...
var file_proto_collector_trace_v1_trace_service_proto_depIdxs = []int32{
...
func init() { file_proto_collector_trace_v1_trace_service_proto_init() }
func file_proto_collector_trace_v1_trace_service_proto_init() {
	if File_proto_collector_trace_v1_trace_service_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_collector_trace_v1_trace_service_proto_rawDesc), len(file_proto_collector_trace_v1_trace_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_collector_trace_v1_trace_service_proto_goTypes,
		DependencyIndexes: file_proto_collector_trace_v1_trace_service_proto_depIdxs,
		MessageInfos:      file_proto_collector_trace_v1_trace_service_proto_msgTypes,
	}.Build()
	File_proto_collector_trace_v1_trace_service_proto = out.File
	file_proto_collector_trace_v1_trace_service_proto_goTypes = nil
	file_proto_collector_trace_v1_trace_service_proto_depIdxs = nil
}
